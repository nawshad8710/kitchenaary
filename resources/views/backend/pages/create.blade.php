		                    ...
		                    <form method="post" action="{{ route('page.store') }}" enctype="multipart/form-data">
		                        ...
		                        <div class="mb-4">
		                          <label for="description_en" class="col-form-label" style="font-weight: bold;">Description (English):</label>
		                            <textarea name="description_en" id="description_en" cols="5" placeholder="Write page description english" class="form-control summernote">{{old('description_en')}}</textarea>
		                        ...
		                        <div class="mb-4">
		                            ...
		                            <textarea name="description_bn" id="description_bn" cols="5" placeholder="Write page description bangla" class="form-control summernote">{{old('description_bn')}}</textarea>
		                        </div>
